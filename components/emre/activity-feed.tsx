    ...
    <div className="glass-panel rounded-xl p-4 space-y-3">
      ...
      <div className="space-y-3">
        {items.map((item, i) => (
          ...
          >
            <div className="mt-1 size-2 rounded-full bg-cyan-400 shrink-0" />
    ...
    <div className="glass-panel rounded-xl p-4 space-y-3">
      ...
      <div className="space-y-2 max-h-80 overflow-y-auto">
        {alerts.slice(0, 8).map((alert) => (
          <div
            key={alert.id}
            className="glass-panel rounded-lg p-3 space-y-1 hover:border-cyan-500/20 transition-colors cursor-pointer"
          >
